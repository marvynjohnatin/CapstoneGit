...
<head>
  <title>Saint James Academy Student Portal</title>
  <meta charset="UTF-8">
...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" method="post" action="<?php echo base_url() ?>faculties/login">
         
          <span class="login100-form-title p-b-43">
            
            <b><font color = red>Teacher Portal</font></b>
          </span>
          
          
          <div class="wrap-input100 validate-input" data-validate = "Valid username is required">
            <input class="input100" type="text" name="facultynumber">
